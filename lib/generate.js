...
var _getMethods = function (methods){
    ...
    var data = fs.readFileSync(__dirname + '/../views/blocks/methods.jade', 'utf8');
...
var _getProperties = function (properties){
    var retstr = "";
    // template working now
    var data = fs.readFileSync(__dirname + '/../views/blocks/properties.jade', 'utf8');
    var fn = jade.compile(data, {pretty:true});
...
var _getEvents = function (events){
    var retstr = "";
    // template working now
    var data = fs.readFileSync(__dirname + '/../views/blocks/events.jade', 'utf8');
    var fn = jade.compile(data, {pretty:true});
